...
import {updateLanguage, updateTheme, updateSlogan, updateInterval} from "../redux/actions/SettingsAction"
...
class SloganTab extends Component {
    ...
    onSave = () => {
        ...
        const { intl } = this.props
        alert(intl.formatMessage({ id: 'action.save.success' }))
        this.setSlogan()
    }
                ...
                <main className={"setting-main"}>
                    <nav className={"setting-nav"}
                        ...
                        <NavLink activeClassName={'selected'}
                                 ...
                                 style={{color: palette.textSecondary}}
                                 to={`${match.url}/other`}>
                            <FormattedMessage id="settings.other"/>
                        </NavLink>
                        {/*<NavLink activeClassName={'selected'}*/}
                        {/*activeStyle={{color: palette.textPrimary}}*/}
                        {/*style={{color: palette.textSecondary}}*/}
                    ...
                    <div className={"settings-content"}>
                        <Switch>
                            ...
                            <Route exact path={`${match.url}/other`}
                                   component={connect(mapStateToProps, mapDispatchToProps)(injectIntl(OtherTab))}/>
